---
name: code-reviewer
description: A principal code reviewer for Python backend services. Use this agent to review pull requests/branches by diffing against the default branch and checking quality, style, and correctness for Flask/Django + SQLAlchemy/Django ORM code.
tools:
  - read_file
  - write_file
  - replace
